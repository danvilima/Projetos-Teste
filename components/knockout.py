...
def get_r32_team(slot_name):
    ...
    if pos == "1º":
        return st.session_state.get(f"group_{group}_1")
    elif pos == "2º":
        return st.session_state.get(f"group_{group}_2")
...
def render_knockout():
    ...
    for mid in r32_matches:
        ...
        render_match_card(mid, th, ta, cols[0], "R32")
    ...
    for mid, (m1, m2) in KNOCKOUT_BRACKET["R16"].items():
        ...
        render_match_card(mid, th, ta, cols[1], "R16")
    ...
    for mid, (m1, m2) in KNOCKOUT_BRACKET["QF"].items():
        ...
        render_match_card(mid, th, ta, cols[2], "QF")
    ...
    for mid, (m1, m2) in KNOCKOUT_BRACKET["SF"].items():
        ...
        render_match_card(mid, th, ta, cols[3], "SF")
    ...
    render_match_card(103, loser1, loser2, cols[4], "3º Lugar")
    ...
    render_match_card(mid, th, ta, cols[4], "Final")
